...
class GetSuperEarthQuiz {
 static List<QuizModel> questions = [
  ...
  QuizModel(
    id: '4',
    title: 'Which exoplanet is known for its potential to have a habitable atmosphere rich in life-friendly molecules?',
    options: {
      'K2-332 b': true,
      'Wolf 1061d': false,
      '55 Cancri e': false,
  ...
  QuizModel(
    ...
    options: {
      ...
      'It is likely a carbon planet with significant amounts of diamond.': true,
  ...
  QuizModel(
    id: '6',
    title: 'Which Super-Earth is known for being one of the closest potentially habitable exoplanets?',
    options: {
      'HD 40307g': false,
      'Gliese 667 Cc': false,
      'Teegarden b': true,

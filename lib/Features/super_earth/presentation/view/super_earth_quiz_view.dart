...
class SuperEarthQuizView extends StatefulWidget {
  const SuperEarthQuizView({super.key});
  static String id = 'SuperEarthQuizView';

  @override
  State<SuperEarthQuizView> createState() => _QuizViewState();
}

class _QuizViewState extends State<SuperEarthQuizView> {
  List<QuizModel> questions = GetSuperEarthQuiz.questions;
  int index = 0;
  int score = 0;

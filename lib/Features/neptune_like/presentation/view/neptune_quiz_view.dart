...
import 'package:p/Features/neptune_like/data/repo/get_neptune_like_quiz.dart';
...
class NeptuneQuizView extends StatefulWidget {
  const NeptuneQuizView({super.key});
  static String id = 'NeptuneQuizView';

  @override
  State<NeptuneQuizView> createState() => _QuizViewState();
}

class _QuizViewState extends State<NeptuneQuizView> {
  List<QuizModel> questions = GetNeptuneLikeQuiz.questions;
  int index = 0;
  int score = 0;

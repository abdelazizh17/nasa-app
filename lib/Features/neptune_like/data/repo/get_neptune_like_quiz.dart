...
class GetNeptuneLikeQuiz {
  static List<QuizModel> questions = [
    ...
    QuizModel(
      id: '4',
      title:
          'Which Neptune-like planet has a very close orbit to its star, completing an orbit in just 1.8 days?',
      options: {
        'Kepler-193 c': false,
        'HN Librae b': false,
        'TOI-1836 c': true,
    ...
    QuizModel(
      id: '5',
      title:
          'Which exoplanet is notable for having a shrinking hydrogen envelope?',
      options: {
        'HD 77946 b': false,
        'Kepler-60 d': false,
        'GJ 436b': true,
    ...
    QuizModel(
      id: '6',
      title:
          'Which Neptune-like planet is located relatively close to Earth at just 51 light-years away?',
      options: {
        'LHS 3154 b': true,
        'HN Librae b': false,
        'NGTS-4b': false,

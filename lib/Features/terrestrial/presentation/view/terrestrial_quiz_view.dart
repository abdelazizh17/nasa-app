...
class TerrestrialQuizView extends StatefulWidget {
  const TerrestrialQuizView({super.key});
  static String id = 'TerrestrialQuizView';

  @override
  State<TerrestrialQuizView> createState() => _QuizViewState();
}
